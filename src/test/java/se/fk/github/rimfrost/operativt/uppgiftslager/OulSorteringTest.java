...
{
   @Test
   @DisplayName("FR-07.1, FR-07.4: Skapa sorteringsordning — svar innehåller genererat id och skapad-tidpunkt")
   ...
   @Test
   @DisplayName("FR-07.2, FR-07.4: Skapa sorteringsordning två gånger — andra skapelsen ersätter den första och får nytt id")
   ...
   @Test
   @DisplayName("FR-08.2: Hämta default sorteringsordning — HTTP 404 när ingen finns")
   ...
   @Test
   @DisplayName("FR-08.1, FR-07.3: Hämta default sorteringsordning — returnerar aktiv sorteringsordning efter skapelse")
   ...
   @Test
   @DisplayName("FR-09.1, FR-09.2: Lista sorteringsordningar — tom lista när ingen finns")
   ...
   @Test
   @DisplayName("FR-09.2, FR-07.3: Lista sorteringsordningar — en post efter skapelse")
   ...
   @Test
   @DisplayName("FR-10.1: Hämta sorteringsordning via id — returnerar rätt post")
   ...
   @Test
   @DisplayName("FR-10.2: Hämta sorteringsordning via id — HTTP 404 när id inte matchar")
